...
enum Стадия_матча_тип {Ничего, Подготовка_матча, Начало_матча, Мулиган, Матч, Конец_матча}
...
func подготовить_матч():
	...
	стадия_матча = Стадия_матча_тип.Начало_матча
func начать_матч():
	
	стадия_матча = Стадия_матча_тип.Мулиган
	pass
func мулиганить():
	
	стадия_матча = Стадия_матча_тип.Матч
	pass
func матч():
	if запуск_таймера:
	...
	контроль_времени()
	время_матча.text = "%02d:%02d" % [int(время)/60, int(время)%60]
	pass
#func мой_ход_начало():
##	if манаИгрок1 < 10:
#	стадия_матча += 1
