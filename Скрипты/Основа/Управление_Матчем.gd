extends Node
## Скрипт управления матчем
## 
## Этот скрипт должен отвечать за создания, проведение, окончание любового матча.
## В силу запутанности кода и отсутсвия внятной структуры, этот скрипт всегда подгружается.[br]
## В обязанности этого скрипта входит всё, что связано с матчем непосредственно:[br]
## 
class_name Управление_матчем
...
var Карты1: Array
var Карты2: Array
var КриваяСтол_X: Curve = load("res://Ресурсы/позиция_карт_в_руке_X.tres")

var поле_матча:PackedScene = load("res://Сцены/стол3d.tscn")
